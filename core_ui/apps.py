...
class CoreUiConfig(AppConfig):
    ...
    def ready(self):
        ...
        from app.core.ai_subscription_gateway import register_subscription_event_provider
        ...
        from core_ui.services.ai_subscription_runtime import stream_persisted_subscription_events
        ...
        register_subscription_event_provider(stream_persisted_subscription_events)
