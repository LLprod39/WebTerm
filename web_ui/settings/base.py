...
MIDDLEWARE = [
    ...
    "core_ui.api_rate_limit.ApplicationRateLimitMiddleware",
    "core_ui.telemetry_middleware.OpenTelemetryMiddleware",
    ...
    "core_ui.api_errors.APIContractMiddleware",
    "core_ui.api_errors.APIErrorMiddleware",
