...
PIPELINE_RUN_STALE_SECONDS = _env_int("PIPELINE_RUN_STALE_SECONDS", 21600)
...
# Automatic OS detection (SSH read-only); UI does not expose manual triggers.
OS_DETECT_CONCURRENCY = _env_int("OS_DETECT_CONCURRENCY", 4)
OS_DETECT_LOCK_SECONDS = _env_int("OS_DETECT_LOCK_SECONDS", 30)
