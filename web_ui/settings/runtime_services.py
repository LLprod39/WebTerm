...
def build_runtime_service_settings(*, base_dir: Path, agent_projects_dir: Path) -> dict[str, object]:
    ...
    return {
        ...
        "AGENT_EXECUTION_REPLICAS": max(1, env_int("AGENT_EXECUTION_REPLICAS", 1)),
        "AGENT_EXECUTION_WORKER_CONCURRENCY": max(1, env_int("AGENT_EXECUTION_WORKER_CONCURRENCY", 1)),
        "AGENT_EXECUTION_GLOBAL_CONCURRENCY": max(1, env_int("AGENT_EXECUTION_GLOBAL_CONCURRENCY", 10)),
        "AGENT_EXECUTION_PER_USER_CONCURRENCY": max(1, env_int("AGENT_EXECUTION_PER_USER_CONCURRENCY", 2)),
        ...
        "KUBERNETES_ADMIN_MODE_ENABLED": env_bool("KUBERNETES_ADMIN_MODE_ENABLED", False),
        "KUBERNETES_ACTION_REQUEST_NATIVE_EXECUTION_ENABLED": env_bool(
            "KUBERNETES_ACTION_REQUEST_NATIVE_EXECUTION_ENABLED", False
        ),
        ...
        "MARS_AGENT_DOCKER_IMAGE": os.getenv("MARS_AGENT_DOCKER_IMAGE", ""),
        ...
        "AGENT_COMMAND_RUNTIME": os.getenv("AGENT_COMMAND_RUNTIME", "docker").strip().lower(),
        "AGENT_COMMAND_DOCKER_COMMAND": os.getenv("AGENT_COMMAND_DOCKER_COMMAND", "docker"),
        "AGENT_COMMAND_RUNNER_IMAGE": os.getenv("AGENT_COMMAND_RUNNER_IMAGE", ""),
        "AGENT_COMMAND_DOCKER_NETWORK": os.getenv("AGENT_COMMAND_DOCKER_NETWORK", "bridge"),
        "AGENT_COMMAND_DOCKER_CPUS": os.getenv("AGENT_COMMAND_DOCKER_CPUS", "0.5"),
        "AGENT_COMMAND_DOCKER_MEMORY": os.getenv("AGENT_COMMAND_DOCKER_MEMORY", "256m"),
