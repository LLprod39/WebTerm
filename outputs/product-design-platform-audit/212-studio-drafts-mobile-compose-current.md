            ...
            - generic [ref=e146] [box=0,229,390,589]:
              ...
              - generic [ref=e153] [box=16,294,358,229]:
                - generic [ref=e154] [box=16,294,358,63]:
                  ...
                  - textbox "Название draft pipeline" [ref=e156] [box=16,317,358,40]: Операционный runbook
              ...
              - generic [ref=e160] [box=16,535,358,166]:
                - button "Ежедневный health-check серверов с Telegram-отчетом и ручным fallback" [ref=e161] [cursor=pointer] [box=16,535,358,50]
                - 'button "Monitoring alert для Docker: диагностика, approval, безопасное восстановление" [ref=e162] [cursor=pointer] [box=16,593,358,50]'
                - 'button "Webhook для задач оператора: принять payload, запустить agent, отправить summary" [ref=e163] [cursor=pointer] [box=16,651,358,50]'
