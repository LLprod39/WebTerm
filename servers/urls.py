...
urlpatterns = [
    ...
    path('api/<int:server_id>/files/chmod/', views.server_file_chmod, name='server_file_chmod'),
    path('api/<int:server_id>/files/chown/', views.server_file_chown, name='server_file_chown'),
    ...
    path('api/<int:server_id>/memory/snapshots/', views.server_memory_snapshots_user, name='server_memory_snapshots_user'),
    path('api/<int:server_id>/memory/snapshots/bulk-delete/', views.server_memory_snapshots_bulk_delete_user, name='server_memory_snapshots_bulk_delete_user'),
    path('api/<int:server_id>/memory/snapshots/<int:snapshot_id>/update/', views.server_memory_snapshot_update, name='server_memory_snapshot_update'),
    path('api/<int:server_id>/memory/snapshots/<int:snapshot_id>/delete/', views.server_memory_snapshot_delete_user, name='server_memory_snapshot_delete_user'),
    path('api/<int:server_id>/memory/purge/', views.server_memory_purge_user, name='server_memory_purge_user'),
