...
def build_kubernetes_terminal_safety_report(user=None, *, policy: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    return {
        ...
        "native_port_forward_tunnel_enabled": bool(getattr(settings, "KUBERNETES_ADMIN_PORT_FORWARD_TUNNEL_ENABLED", False)),
        "port_forward_recording_enabled": bool(getattr(settings, "KUBERNETES_ADMIN_PORT_FORWARD_RECORDING_ENABLED", False)),
        "cluster_terminal_enabled": bool(getattr(settings, "KUBERNETES_ADMIN_CLUSTER_TERMINAL_ENABLED", False)),
        "cluster_terminal_recording_enabled": bool(getattr(settings, "KUBERNETES_ADMIN_CLUSTER_TERMINAL_RECORDING_ENABLED", False)),
        ...
        "interactive_metadata_retention_days": int(getattr(settings, "KUBERNETES_ADMIN_INTERACTIVE_METADATA_RETENTION_DAYS", 365) or 365),
        "interactive_transcript_retention_days": int(getattr(settings, "KUBERNETES_ADMIN_INTERACTIVE_TRANSCRIPT_RETENTION_DAYS", 30) or 30),
        "transcript_event_max_chars": int(getattr(settings, "KUBERNETES_ADMIN_TRANSCRIPT_EVENT_MAX_CHARS", 2000) or 2000),
        "transcript_event_max_count": int(getattr(settings, "KUBERNETES_ADMIN_TRANSCRIPT_EVENT_MAX_COUNT", 2000) or 2000),
