...
class Command(BaseCommand):
    help = "Write Kubernetes Ops interactive live-smoke evidence without opening production live streams."

    def add_arguments(self, parser):
        parser.add_argument("--output", default=INTERACTIVE_LIVE_SMOKE_ARTIFACT, help="Output JSON evidence path.")
    ...
    def handle(self, *args, **options):
        ...
        write_kubernetes_interactive_live_smoke(report, output_path)
        self.stdout.write(f"Wrote Kubernetes Ops interactive live-smoke evidence: {output_path}")
