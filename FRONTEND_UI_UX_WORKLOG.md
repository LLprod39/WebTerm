...
- Frontend app: `ai-server-terminal-main`.
...
From `C:\WebTrerm\ai-server-terminal-main`:
...
- Extracted MCP dialog/report UI into:
  - `ai-server-terminal-main/src/components/studio/MCPForm.tsx`
  - `ai-server-terminal-main/src/components/studio/AgentReportModal.tsx`
...
- Improved `PipelineRunsPage`:
  ...
  - detail rendering is now split into `ai-server-terminal-main/src/components/studio/PipelineRunDetail.tsx`.
...
- Improved `/studio` overview:
  ...
  - added localized pipeline activity text helpers in `ai-server-terminal-main/src/components/studio/StudioActivityText.ts`;
