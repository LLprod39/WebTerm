...
- Changes after `v0.1.0`, including the 2026-07-29 security hardening, are unreleased. They must pass the protected [hardening pull request](https://github.com/LLprod39/WebTerm/pull/26), receive the required independent review and run a new tag workflow before release.
...
| Security scan | repository-wide approved scanner command from F-03/F-10 | SARIF/report and finding ledger | `v0.1.0`: dependency audits, secrets/security tests and supply-chain checks passed. The 2026-07-29 sealed review was remediated on PR #26 and remains unreleased pending protected checks and review. |
