...
There are root frontend scripts and a full frontend app under `frontend/`. This confuses developer workflow.

Implementation:

1. Decide canonical frontend location: likely `frontend/`.
