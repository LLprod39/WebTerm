...
Enforces the structural constraints defined in ARCHITECTURE_CONTRACT.md:
...
class ArchitectureConfig:
    ...
    contract_file: str = "ARCHITECTURE_CONTRACT.md"
    ...
    def from_toml(cls, config_path: str = "pyproject.toml") -> ArchitectureConfig:
        ...
        try:
            ...
            return cls(
                ...
                contract_file=arch.get("contract_file", "ARCHITECTURE_CONTRACT.md"),
                legacy_baselines={
