"""Server update approval pipeline template."""
    ...
    "nodes": [
        ...
        },
        {
            ...
            "data": {
                ...
                "bot_token": "",
                "chat_id": "",
                "message": ("Обновление сервера начнётся через 1 мин.\n\nСписок пакетов:\n{n5_output}"),
            },
        },
        ...
        },
        {
            ...
            "data": {
                ...
                "bot_token": "",
                "chat_id": "",
                "message": ("Обновление сервера выполнено. Запущена проверка сервисов.\n\nЛог: {n8_output}"),
            },
        },
