...
export const NODE_PALETTE = [
  ...
  },
  {
    category: "Ops",
    nodes: [
      { type: "ops/server_snapshot" as NodeType, label: "Server Snapshot", icon: Server, iconClassName: "text-cyan-400", description: "Read-only Linux server snapshot" },
      { type: "ops/log_query" as NodeType, label: "Log Query", icon: FileText, iconClassName: "text-lime-400", description: "Read-only Linux/service/Docker logs" },
      { type: "ops/file_action" as NodeType, label: "File Action", icon: FileText, iconClassName: "text-yellow-400", description: "Read or write UTF-8 text files" },
      ...
      { type: "ops/backup_restore_check" as NodeType, label: "Backup Check", icon: HardDrive, iconClassName: "text-emerald-400", description: "Check backup freshness and archive integrity" },
      ...
      { type: "ops/process_action" as NodeType, label: "Process Action", icon: Terminal, iconClassName: "text-red-400", description: "Terminate or force kill a process" },
      ...
      { type: "ops/alert_update" as NodeType, label: "Alert Update", icon: Bell, iconClassName: "text-amber-400", description: "Resolve a WebTerm monitoring alert" },
    ],
  },
  {
    category: "Logic",
