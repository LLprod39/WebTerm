...
export function getCuratedDefaultDashboardLayout(
  ...
  if (type === "user") {
    // Default for all non-admin users (from german.keller production layout).
    // Users can still customize and save their own layout later.
    return [
      { id: "servers_health", x: 0, y: 0, w: 12, h: 1, props: { tone: "default", limit: 5 } },
      { id: "quick_stats", x: 0, y: 1, w: 12, h: 1, props: { tone: "default", limit: 5 } },
      { id: "recent_runs", x: 0, y: 2, w: 6, h: 1, props: { tone: "default", limit: 5 } },
      { id: "user_alerts", x: 6, y: 2, w: 6, h: 1, props: { tone: "default", limit: 5 } },
    ];
  }
  return [
    {
