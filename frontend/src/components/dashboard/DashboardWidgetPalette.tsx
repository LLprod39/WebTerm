                  ...
                  >
                    <div className="space-y-1.5">
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-xs font-mono text-muted-foreground/60 bg-secondary px-1.5 py-0.5 rounded shrink-0">
                          Ширина: {defaultWidthText}
                        </span>
                      </div>

                      <p className="text-xs text-muted-foreground/80 leading-relaxed min-h-[30px] line-clamp-2">
                        {description}
                      </p>
                    </div>

                    <div className="mt-3 flex items-center justify-between pt-2.5 border-t border-border/30">
                      <span className="text-xs text-muted-foreground/50">ID: {widget.id}</span>
                      <div className="flex items-center gap-1.5">
                        <span className={cn("h-1.5 w-1.5 rounded-full", isActive ? "bg-emerald-500" : "bg-muted-foreground/35")} />
                        <span className={cn("text-xs font-bold", isActive ? "text-emerald-500" : "text-muted-foreground")}>
