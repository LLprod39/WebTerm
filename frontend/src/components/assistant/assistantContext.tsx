  ...
  if (root === "servers" && parts[1] && parts[2] === "terminal") {
    ...
    return {
      ...
      chips: [
        ...
        {
          id: "load",
          labelRu: "Load average",
          labelEn: "Load average",
          promptRu: "Покажи load average, top CPU/RAM процессы и что необычного.",
  ...
  if (root === "servers") {
    return {
      ...
      chips: [
        {
          id: "fleet",
          labelRu: "Статус флота",
          labelEn: "Fleet status",
          promptRu: "Краткий статус флота: online/offline, worst hosts, алерты.",
        ...
        },
        {
          ...
          labelEn: "Add SSH",
          promptRu: "Помоги добавить новый SSH-сервер: что спросить у оператора.",
      ...
      chips: [
        {
          ...
          labelRu: "Почему упал?",
          labelEn: "Why failed?",
          promptRu: "Почему этот прогон упал? Разбери шаги и укажи root cause.",
          promptEn: "Why did this run fail? Review steps and give root cause.",
        },
        {
          id: "retry",
          labelRu: "Повтори с фиксом",
          labelEn: "Retry with fix",
          promptRu: "Предложи фикс и как безопасно повторить прогон.",
      ...
      chips: [
        {
          ...
          labelEn: "List agents",
          promptRu: "Покажи агентов и кто сейчас бежит.",
          promptEn: "List agents and who is running now.",
        },
        {
          id: "backup",
          labelRu: "Шаблон бэкапов",
          labelEn: "Backup template",
          promptRu: "Создай мини-агента для проверки бэкапов на выбранных серверах.",
    ...
    chips: [
      {
        ...
        labelRu: "Брифинг",
        labelEn: "Briefing",
        promptRu: "Краткий операторский брифинг: флот, алерты, агенты.",
