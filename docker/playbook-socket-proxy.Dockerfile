...
COPY app/ai_cli_socket_proxy_policy.py ./ai_cli_socket_proxy_policy.py
COPY app/plugin_backend_socket_proxy_policy.py ./plugin_backend_socket_proxy_policy.py
